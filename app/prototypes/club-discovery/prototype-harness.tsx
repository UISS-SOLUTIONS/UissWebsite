...
import { CivicGrid } from "./variant-civic-grid";
import { CommunityCanvas } from "./variant-community-canvas";
import { TechnicalIndex } from "./variant-technical-index";

const variants = [
  { name: "Civic", component: CivicGrid },
  { name: "Index", component: TechnicalIndex },
  { name: "Canvas", component: CommunityCanvas },
];

export function ClubDiscoveryHarness() {
