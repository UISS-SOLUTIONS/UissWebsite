...
import { LeadershipBoard } from "./variant-board";
import { LeadershipCarousel } from "./variant-carousel";
import { LeadershipDirectory } from "./variant-directory";

const variants = [
  { name: "Carousel", component: LeadershipCarousel },
  { name: "Board", component: LeadershipBoard },
  { name: "Directory", component: LeadershipDirectory },
];

export function LeadershipTeamHarness() {
