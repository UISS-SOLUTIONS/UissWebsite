...
const sidebarData: SidebarData = {
  logo: {
    src: "/dashboard/uiss-logo.jpg",
    alt: "UISS official logo",
    title: "UISS",
    ...
    <SidebarMenu>
      <SidebarMenuItem>
        <SidebarMenuButton size="lg">
          <div className="flex aspect-square size-8 items-center justify-center overflow-hidden rounded-sm bg-black">
            <Image
              src={logo.src}
              alt={logo.alt}
              width={32}
