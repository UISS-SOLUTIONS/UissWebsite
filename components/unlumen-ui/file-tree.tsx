  ...
  return (
    <FolderContext.Provider value={{ isOpen, toggle }}>
      <div data-value={node.id} className="relative z-10">
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 p-2 pointer-events-none">
              {showIcons && (
                <FolderIcon
                  closeIcon={<Folder className="size-[18px]" />}
                  openIcon={<FolderOpen className="size-[18px]" />}
                />
              )}
              <span
                className="text-sm"
        ...
        <div
          className="relative ml-6 before:absolute before:-left-2 before:inset-y-0 before:h-full before:w-px before:bg-border"
    ...
    <MotionConfig reducedMotion="user">
      ...
      >
        ...
        >
          ...
          >
            <FileTreeHoverHighlight className="z-0 rounded-lg border border-border bg-muted/60" />
            {elements.map((node) => (
