          ...
          <AnimatePresence initial={false}>
            {boundsState && (
              <motion.div
                ...
                transition={transition}
                className={cn(
                  "absolute bg-oklch(0.97 0 0) z-0 dark:bg-oklch(0.269 0 0)",
                  className,
...
function HighlightItem({
  ...
  const childRef = element?.props.ref as React.Ref<HTMLElement> | undefined;
  const composedRef = useComposedRefs<HTMLElement>(
    childRef,
    localRef as unknown as React.Ref<HTMLElement>,
  ...
  if (asChild) {
    // The composed ref below replaces the child ref while preserving the other props.
          ...
          <AnimatePresence initial={false}>
            {isActive && !isDisabled && (
              <motion.div
                ...
                data-slot="motion-highlight"
                className={cn(
                  "absolute inset-0 bg-oklch(0.97 0 0) z-0 dark:bg-oklch(0.269 0 0)",
                  contextClassName,
                  activeClassName,
                )}
