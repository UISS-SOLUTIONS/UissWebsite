...
function MotionNavigationMenuList({
  ...
  return (
    <Highlight
      ...
      hover
      className={cn(
        "bg-oklch(0.97 0 0) rounded-md pointer-events-none dark:bg-oklch(0.269 0 0)",
        highlightClassName,
      )}
      style={{ zIndex: -1 }}
...
const motionNavigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-transparent px-4 py-2 text-sm font-medium hover:text-oklch(0.205 0 0) focus:text-oklch(0.205 0 0) disabled:pointer-events-none disabled:opacity-50 data-[state=open]:text-oklch(0.205 0 0) focus-visible:ring-oklch(0.708 0 0)/50 outline-none transition-colors focus-visible:ring-[3px] focus-visible:outline-1 dark:hover:text-oklch(0.985 0 0) dark:focus:text-oklch(0.985 0 0) dark:data-[state=open]:text-oklch(0.985 0 0) dark:focus-visible:ring-oklch(0.556 0 0)/50",
);
    ...
    <AnimatePresence initial={false} custom={context.direction}>
      {isOpen && (
        <motion.div
          ...
          className={cn(
            "bg-oklch(1 0 0)/90 text-oklch(0.145 0 0) absolute top-full left-0 z-50 mt-1.5 rounded-md border border-oklch(0.922 0 0) p-2 pr-2.5 shadow dark:bg-oklch(0.145 0 0)/90 dark:text-oklch(0.985 0 0) dark:border-oklch(1 0 0 / 10%)",
            className,
          )}
        >
...
function MotionNavigationMenuContentInner({
  ...
  return (
    <Highlight
      ...
      hover
      className={cn(
        "bg-oklch(0.97 0 0) rounded-sm pointer-events-none dark:bg-oklch(0.269 0 0)",
        highlightClassName,
      )}
      style={{ zIndex: -1 }}
      containerClassName="relative"
  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={context?.spring}
        className={cn(
          "bg-oklch(1 0 0) text-oklch(0.145 0 0) relative mt-1.5 overflow-hidden rounded-md border border-oklch(0.922 0 0) shadow backdrop-blur-md dark:bg-oklch(0.145 0 0) dark:text-oklch(0.985 0 0) dark:border-oklch(1 0 0 / 10%)",
          className,
        )}
      >
        <AnimatePresence
  ...
  return (
    <HighlightItem asChild>
      <a
        ...
        className={cn(
          "data-[active=true]:text-oklch(0.205 0 0) hover:text-oklch(0.205 0 0) focus:text-oklch(0.205 0 0) focus-visible:ring-oklch(0.708 0 0)/50 [&_svg:not([class*='text-'])]:text-oklch(0.556 0 0) flex flex-col gap-1 rounded-sm p-2 text-sm transition-colors outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4 dark:data-[active=true]:text-oklch(0.985 0 0) dark:hover:text-oklch(0.985 0 0) dark:focus:text-oklch(0.985 0 0) dark:focus-visible:ring-oklch(0.556 0 0)/50 dark:[&_svg:not([class*='text-'])]:text-oklch(0.708 0 0)",
          className,
        )}
        {...props}
      />
...
function MotionNavigationMenuIndicator({
  ...
  return (
    <div
      ...
      {...props}
    >
      <div className="bg-oklch(0.922 0 0) relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm shadow-md dark:bg-oklch(1 0 0 / 10%)" />
    </div>
  );
}
